...
(function (e, t) {
  ...
  function m() {
    ...
    for (var t = 0; t < e.length; t++)
      e[t].type.match(p) &&
        new r.Parser({ filename: document.location.href.replace(/#.*$/, ''), dumpLineNumbers: r.dumpLineNumbers }).parse(e[t].innerHTML || '', function (n, r) {
          var i = r.toCSS(),
            s = e[t];
      ...
      x(
        ...
        function (e, l) {
          ...
          if (!i && p && l && new Date(l).valueOf() === new Date(p.timestamp).valueOf()) (S(p.css, t), n(null, null, e, t, { local: !0, remaining: s }, f));
            ...
            try {
              ((o[f] = e),
                new r.Parser({ optimization: r.optimization, paths: [a.path], entryPath: t.entryPath || a.path, mime: t.type, filename: f, rootpath: d, relativeUrls: t.relativeUrls, contents: o, files: u, dumpLineNumbers: r.dumpLineNumbers }).parse(e, function (r, i) {
                  if (r) return k(r, f);
                  try {
  ...
  function k(e, t) {
    ...
    (e.stack ? (u += '<br/>' + e.stack.split('\n').slice(1).join('<br/>')) : e.extract && (c(e, 0, ''), c(e, 1, 'line'), c(e, 2, ''), (u += 'on line ' + e.line + ', column ' + (e.column + 1) + ':</p>' + '<ul>' + a.join('') + '</ul>')),
      (s.innerHTML = u),
      S(['.less-error-message ul, .less-error-message li {', 'list-style-type: none;', 'margin-right: 15px;', 'padding: 4px 0;', 'margin: 0;', '}', '.less-error-message label {', 'font-size: 12px;', 'margin-right: 15px;', 'padding: 4px 0;', 'color: #cc7777;', '}', '.less-error-message pre {', 'color: #dd6666;', 'padding: 4px 0;', 'margin: 0;', 'display: inline-block;', '}', '.less-error-message pre.line {', 'color: #ff0000;', '}', '.less-error-message h3 {', 'font-size: 20px;', 'font-weight: bold;', 'padding: 15px 0 5px 0;', 'margin: 0;', '}', '.less-error-message a {', 'color: #10a', '}', '.less-error-message .error {', 'color: red;', 'font-weight: bold;', 'padding-bottom: 2px;', 'border-bottom: 1px dashed red;', '}'].join('\n'), { title: 'error-message' }),
  ...
  var r, i, s;
  (typeof environment == 'object' && {}.toString.call(environment) === '[object Environment]' ? (typeof e == 'undefined' ? (r = {}) : (r = e.less = {}), (i = r.tree = {}), (r.mode = 'rhino')) : typeof e == 'undefined' ? ((r = exports), (i = n('./tree')), (r.mode = 'node')) : (typeof e.less == 'undefined' && (e.less = {}), (r = e.less), (i = e.less.tree = {}), (r.mode = 'browser')),
    (r.Parser = function (t) {
      function g() {
        ((a = c[u]), (f = o), (h = o));
      }
          ...
          parse: function (e, a) {
            ...
            ((o = u = h = l = 0),
              ...
              (c = (function (e) {
                ...
                return (
                  u != 0 && (x = new O({ index: c - 1, type: 'Parse', message: u > 0 ? 'missing closing `}`' : 'missing opening `{`', filename: t.filename }, t)),
                  e.map(function (e) {
                    return e.join('');
                  })
                );
  ...
  if (r.mode === 'browser' || r.mode === 'rhino')
    r.Parser.importer = function (e, t, n, r) {
      (!/^([a-z-]+:)?\//.test(e) && t.length > 0 && (e = t[0] + e),
        w(
          { href: e, title: e, type: r.mime, contents: r.contents, files: r.files, rootpath: r.rootpath, entryPath: r.entryPath, relativeUrls: r.relativeUrls },
    ...
    (function (e) {
      ((e.Import = function (t, n, r, i, s, o) {
        ...
        ((this.once = i),
          ...
          (this.rootpath = o),
          t instanceof e.Quoted ? (this.path = /(\.[a-z]*$)|([\?;].*)$/.test(t.value) ? t.value : t.value + '.less') : (this.path = t.value.value || t.value),
    ...
    (function (e) {
      ((e.Selector = function (e) {
        ...
        (e.Selector.prototype.toCSS = function (e) {
          return this._css
            ? this._css
            : (this.elements[0].combinator.value === '' ? (this._css = ' ') : (this._css = ''),
